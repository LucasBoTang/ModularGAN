...
if __name__ == '__main__':
    ...
    parser.add_argument('--e_repeat_num', type=int, default=0, help='number of residual blocks in Encoder')
    ...
    parser.add_argument('--num_epochs', type=int, default=20, help='number of total iterations for training D')
    parser.add_argument('--num_epochs_decay', type=int, default=10, help='number of iterations for decaying lr')
    parser.add_argument('--g_lr', type=float, default=0.00005, help='learning rate for Generation')
    parser.add_argument('--d_lr', type=float, default=0.00005, help='learning rate for Discrimination')
